...
public class HotelLogic {
    ...
    public ArrayList<Customer> addCustomer(ArrayList<Customer> arraylistcustomer) {
        ...
        public ArrayList<Customer> removeCustomer
        (ArrayList < Customer > arraylistcustomer, ArrayList < Booking > bookings){
        ...
        public ArrayList<Booking> makeBooking
        (ArrayList < Booking > bookings, ArrayList < Customer > arrayListCustomer, ArrayList < Room > hotelRooms){
